...
In this repository, I created a chat app written in Python programming language. A chat application is a communication medium meaning that a we have a **sender** and a **receiver**.
